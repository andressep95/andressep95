...
### SQLift - JPA Class Generator from Postgres DDL
A CLI tool that processes Postgres DDL files to automatically generate JPA entity classes.

**Key Features:**
- Native executables for Mac/Linux (built with GraalVM)
...
- 👨‍🏫 Technical Instructor - Java Fullstack Bootcamps
- 👨‍💻 Java Developer Intern @ Globant (2024)
...
💡 Always open to collaborate on innovative backend projects and knowledge-sharing opportunities!